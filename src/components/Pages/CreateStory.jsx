...
const CreateStory = ({ history }) => {
  ...
  // useEffect(
	// 	() => {
  //     if(appState.auth.userInfo.role === 'admin') {
  //       history.push('/dashboard')
  //     }
	// 	},
	// 	[history, appState.auth.userInfo.role]
	// );
	...
	const formSubmitHandler = (e) => {
		...
		dispatch(addStoryAction(history));
	};

	return (
    
		<Fragment>
    {appState.auth.userInfo.role === 'user' ?
    <div className="app-form">
			...
			{appState.loader.appLoader ? (
				...
				<form onSubmit={formSubmitHandler}>
					...
					<div className={appState.stories.message.category === 'success' ? 'success-msg' : 'error-msg'}>
